...
export const metadata = {
  title: "About",
  description: "About Colouresh - Nigerian journalism, interviews and opinion.",
};
...
export default function AboutPage() {
  return (
    <LegalPageLayout
      ...
      intro="Colouresh covers Nigerian politics, business, security and public life for readers who need the whole picture, not just the headline."
    >
      <LegalSection title="What we do">
        <p>
          Colouresh is an editorial newsroom built around beat reporting, interviews and analysis
      ...
      <LegalSection title="Free and Premium">
        <p>
          ...
          interviews and specialist analysis — are marked as such and available to Colouresh
          subscribers. See{" "}
