...
/**
 * A minimal single-field popover: used wherever the brief calls for a
 * quick text capture (link URL, video URL, embed code, a private note)
 * without reaching for a native `prompt()` or a full modal.
 */
