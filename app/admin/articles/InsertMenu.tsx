...
import { Plus, ImagePlus, Search, Video, Code2, Minus } from "lucide-react";
...
type Panel = "library" | "video" | "embed" | null;
      ...
      {expanded ? (
        <div className="ml-2">
          ...
          >
            ...
            <StripButton label="Embed video" onClick={() => setPanel("video")}>
              <Video size={ICON_SIZE} />
            </StripButton>
            <StripButton label="Embed code" onClick={() => setPanel("embed")}>
